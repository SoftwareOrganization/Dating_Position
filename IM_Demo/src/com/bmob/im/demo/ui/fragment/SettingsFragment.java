...
import com.bmob.im.demo.MyDatePositionManage;
...
public class SettingsFragment extends FragmentBase implements OnClickListener{
	...
	RelativeLayout layout_info, rl_switch_notification, rl_switch_voice,
			rl_switch_vibrate,layout_blacklist, rl_date_manage;
	...
	private void initView() {
		...
		rl_date_manage = (RelativeLayout) findViewById(R.id.layout_date_manage);
		...
		rl_date_manage.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.layout_date_manage:
			Intent intent2 = new Intent();
			intent2.setClass(getActivity(), MyDatePositionManage.class);
